...
const NewsPage: React.FC = () => {
  ...
  useEffect(() => {
    document.title = language === 'vi' ? 'Tin tức & Sự kiện - GAET' : 'News & Events - GAET Corporation';
  ...
  const staticNewsItems_en = [
    {
      ...
      date: "26/03/2025",
      category: "Internal News, Activity News",
    ...
    },
    {
      ...
      date: "24/03/2025",
      category: "Activity News, Featured News",
  ...
  const displayItems = newsItems.length > 0 
    ? newsItems 
    : language === 'vi' ? staticNewsItems_vi : staticNewsItems_en;
